...
export const Expensedetails = ({ expenseid }) => {
    ...
    return (
        <div className='container mx-auto h-auto mt-2 flex flex-col lg:grid lg:grid-cols-5 gap-4'>
            ...
            <div className="Overview lg:col-span-2 xl:col-span-3">
                <Overview Expense={Expense} />
            </div>

            <div className="insights lg:col-span-3 xl:col-span-2">
            ...
            <div className="Settlements lg:col-span-2 h-[350px] md:h-[540px]">
