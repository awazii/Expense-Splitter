...
const Friendsnav = forwardRef((ref) => {
  return (
    <>
      <div className={`actions flex gap-4  justify-end items-center px-10  h-full`} >
        <h2 className="absolute left-0 ml-6 text-2xl font-medium p-6">
...
export const Friends = () => {
  ...
  return (
    <div className="Friends-main h-full overflow-auto scrollbar-hide relative">
      ...
      <div ref={sentinelRef} />
      <div className={`h-20 sticky top-0 z-20 ${isStuck?"card-b border-b-1 border-0 rounded-t-xl":""}`}>
